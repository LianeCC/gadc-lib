...
export function scrollToFirstError() {
    ...
    if (firstError) {
        ...
        const inputElement = (_a = firstError.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('input, select, textarea');
        if (inputElement) {
 ...
 */
export function validateFormAndScroll(errors) {
